...
public class QuestionListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add(new FlashCard("Quel est le prénom du père Simpson ?", "none", "homer", answerEasy1, 1));
        questions.add(new FlashCard("Quel est le prénom de la mère Simpson ?", "none", "marge", answerEasy2, 2));
        ...
        questions.add(new FlashCard("Quel est le prénom du fils Simpson ?", "none", "bart", answerMedium1, 2));
        questions.add(new FlashCard("Quel est le prénom de la fille ainée Simpson ?", "none", "lisa", answerMedium2, 1));
        ...
        questions.add(new FlashCard("Quel est la couleur de la voiture des Simpson ?", "none", "voiture", answerHard1, 2));
        questions.add(new FlashCard("Quel est le prénom du grand-père Simpson ?", "none", "grandpa", answerHard2, 0));
